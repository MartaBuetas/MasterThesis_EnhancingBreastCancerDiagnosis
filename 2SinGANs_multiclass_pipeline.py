...
## Balancing (optional): only for the train set with 2 SinGAN models generated data (the path should be changed to the right one) 
...
#77.png and 2789.png have 200 samples each
...
synthetic_datasets_group3=[syn_dataset_digital_1_group3, syn_dataset_film_1_group3]
...
synthetic_features_group3=[features_2789, features_77]
...
syn_dataset_digital_1_group3, syn_dataset_film_1_group3 = synthetic_datasets_group3
...
for test_indices, train_val_indices in splitter.split(data['train'], healthy, groups=groups):
  ...
  if join_synthetic_group3:
    ...
    syn_dataset_group3=concatenate_datasets([syn_dataset_digital_1_group3['train'].select(list(range(0,samples_per_sinGAN))), syn_dataset_film_1_group3['train'].select(list(range(0,samples_per_sinGAN)))], axis=0)
