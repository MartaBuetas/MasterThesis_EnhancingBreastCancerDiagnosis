...
## Balancing (optional): only for the train set with 8 SinGAN models generated data (the path should be changed to the right one) 
...
syn_dataset_film_3_group3 = load_dataset("imagefolder", data_dir='/home/marta/SinGAN/Output/RandomSamples/168_resized/gen_start_scale=0')
syn_dataset_film_4_group3 = load_dataset("imagefolder", data_dir='/home/marta/SinGAN/Output/RandomSamples/51_resized/gen_start_scale=0')
...
syn_dataset_digital_3_group3 = load_dataset("imagefolder", data_dir='/home/marta/SinGAN/Output/RandomSamples/2180_resized/gen_start_scale=0')
syn_dataset_digital_4_group3 = load_dataset("imagefolder", data_dir='/home/marta/SinGAN/Output/RandomSamples/3884_resized/gen_start_scale=0')
...
features_2180=metadata_df[metadata_df['file_name']=='2180.png']
features_168=metadata_df[metadata_df['file_name']=='168.png']
features_51=metadata_df[metadata_df['file_name']=='51.png']
features_3884=metadata_df[metadata_df['file_name']=='3884.png']
...
synthetic_features_group3=[features_2789, features_3941, features_2180, features_3884, features_77, features_13, features_168, features_51]
...
syn_dataset_digital_1_group3, syn_dataset_digital_2_group3, syn_dataset_digital_3_group3, syn_dataset_digital_4_group3, syn_dataset_film_1_group3, syn_dataset_film_2_group3, syn_dataset_film_3_group3, syn_dataset_film_4_group3 = synthetic_datasets_group3
...
def train_model(model, criterion, optimizer, scheduler, num_epochs=10):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch == num_epochs-1:
          ...
          for class_idx in range(y_true.shape[1]):  # Assumes y_true.shape[1] is the number of classes
...
if GRID_SEARCH==False:
  ...
  with open(os.path.join(save_folder,"output.txt"), "w") as file:
      ...
      if misclassified_images:
        save_folder = os.path.join('/home/marta/Multiclass', save_folder_name)
